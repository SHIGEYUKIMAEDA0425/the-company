                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="edit-user.php" class="btn btn-outline-warning border-0 btn-sm" title="Edit"><i
                                    class="fa-solid fa-pen"></i></a>
                            <a href="delete-user.php" class="btn btn-outline-danger border-0 btn-sm" title="delete"><i
